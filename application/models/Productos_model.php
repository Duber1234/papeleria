...
class Productos_model extends CI_Model
{
    ...
    var $table = 'productos';	
    var $column_order = array(null,'id_producto', 'codigo','nombre','cantidad', 'precio_fabrica', 'precio_venta'); //set column field database for datatable orderable
    var $column_search = array('id_producto','codigo' ,'nombre'); //Establecer base de datos de campo de columna para la tabla de datos
